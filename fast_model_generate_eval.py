...
def parse_option():
    ...
    parser.add_argument('--prompt-template', type=int, default=-1)
    parser.add_argument('--prompt-saving', action='store_true', default=False)
    parser.add_argument('--instruct-prompt-v2', action='store_true', default=False)
    parser.add_argument('--no-exemplar', action='store_true', default=False)
    parser.add_argument('--regex-assert', action='store_true', default=False)
    ...
    parser.add_argument('--test-prompt', type=int, default=0)
    ...
    parser.add_argument('--error-log-regenerate', action='store_true', default=False)
