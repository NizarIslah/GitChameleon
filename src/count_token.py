...
def tokenize_sample(sample, tokenizer):
    ...
    sample["token_count"] = len(token_ids) # Add 100 to token count to account for the comments
...
if __name__ == "__main__":
    ...
    parser.add_argument("input_filepath", type=str, help="Path to the input JSONL file.")
    parser.add_argument("output_filepath", type=str, help="Path to the output JSONL file.")
    ...
    max_sample, max_token_count, count_above_256 = process_file(input_filepath, output_filepath, tokenizer)
