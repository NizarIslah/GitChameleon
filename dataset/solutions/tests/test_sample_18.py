...
class TestSpatialJoin(unittest.TestCase):
    """Test cases for the spatial_join function in sample_18.py."""
    ...
    def test_basic_functionality(self):
        ...
        self.assertEqual(point1_result['id_right'].iloc[0], 1)  # Point1 should be in Polygon1
        self.assertEqual(point1_result['name'].iloc[0], 'Polygon1')
        
        self.assertEqual(point2_result['id_right'].iloc[0], 2)  # Point2 should be in Polygon2
    ...
    def test_different_predicate(self):
        ...
        # If the function were modified to accept a predicate parameter, we would test like:
        # result_intersects = spatial_join(self.points_gdf, self.polygons_gdf, predicate='intersects')
        # self.assertEqual(len(result_intersects), 2)  # Same result for this specific case
    ...
    def test_large_datasets_performance(self):
        ...
        print(f"Large dataset spatial join execution time: {execution_time:.4f} seconds")
