...
class TestSample284(unittest.TestCase):
    ...
    def test_compute_stream(self):
        ...
        stream, stream_blocks = patched_compute_stream(self.filename, self.n_fft, self.hop_length)
        ...
        for block in stream_blocks:
            ...
            self.assertEqual(block.shape[0], self.n_fft // 2 + 1)  # Number of frequency bins
