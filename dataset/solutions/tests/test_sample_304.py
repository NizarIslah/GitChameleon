...
class TestComputeLocalmin(unittest.TestCase):
    ...
    def test_edge_cases(self):
        ...
        expected_first = np.array([False, False, False, False])  # First element is never a local minimum
        ...
        expected_last = np.array([False, False, False, True])  # Last element can be a local minimum
