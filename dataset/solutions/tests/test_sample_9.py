...
class TestBesselI0(unittest.TestCase):
    ...
    def test_basic_positive_values(self):
        ...
        # I₀(0) = 1
        self.assertTrue(torch.isclose(result[0], torch.tensor(1.0, dtype=torch.float32)))
    ...
    def test_zero_value(self):
        ...
        # I₀(0) should be 1
        self.assertTrue(torch.allclose(result, torch.tensor([1.0], dtype=torch.float32)))
    ...
    def test_small_values(self):
        ...
        self.assertTrue(torch.isclose(result[0], expected_approx, rtol=1e-10, atol=1e-10))
    ...
    def test_bessel_i0_properties(self):
        ...
        # I₀(0) = 1
        self.assertTrue(torch.isclose(bessel_i0(torch.tensor([0.0], dtype=torch.float64))[0], 
