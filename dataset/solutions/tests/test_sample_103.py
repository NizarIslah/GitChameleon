...
from dataset.solutions.sample_103 import SampleForm, render_output, get_template_string
...
class TestSample103(unittest.TestCase):
    ...
    def test_form_rendering_with_as_field_group(self):
        ...
        self.assertIn('<div class="helptext" id="id_name_helptext">Enter your name</div>', rendered_html)
