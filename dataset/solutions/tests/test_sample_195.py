...
# Add the parent directory to the path so we can import the sample_195 module
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

from sample_195 import custom_bottom_up
from sympy import symbols, sin, cos, exp, pi, sqrt, Function, Derivative, Integral


class TestCustomBottomUp(unittest.TestCase):
