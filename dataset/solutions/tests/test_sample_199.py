...
class TestCustomDivides(unittest.TestCase):
    ...
    def test_with_large_numbers(self):
        ...
        self.assertFalse(custom_divides(1000001, 1000))  # 1000001 is not divisible by 1000
        self.assertFalse(custom_divides(2**20 + 1, 2**10))  # 2^20 + 1 is not divisible by 2^10
