...
class TestBoundingDistance(unittest.TestCase):
    """Test cases for the bounding_distance function in sample_29.py."""
    ...
    def test_simple_connected_graph(self):
        ...
        distance = sample_29.bounding_distance(G)
    ...
    def test_graph_with_multiple_components(self):
        ...
        try:
            ...
            self.assertTrue("disconnected" in str(e) or 
                           "Infinite" in str(e) or 
                           "connected" in str(e))
    ...
    def test_directed_graph_input(self):
        ...
        try:
            ...
            self.assertTrue("directed" in str(e) or 
                           ...
                           "not strongly connected" in str(e) or
                           "infinite path length" in str(e))
