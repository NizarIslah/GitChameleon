...
class TestHilbertTransform(unittest.TestCase):
    ...
    def test_different_dtypes(self):
        ...
        self.assertEqual(result.dtype, np.complex64)  # Hilbert transform of float32 is complex64
        
        # Test with float64 dtype explicitly
        result_float64 = compute_hilbert_transform(a, b, dtype=np.float64)
        self.assertEqual(result_float64.dtype, np.complex128)  # Hilbert transform of float64 is complex128
