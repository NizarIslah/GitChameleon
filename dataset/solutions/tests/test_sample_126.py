...
class TestLanczosWindow(unittest.TestCase):
    ...
    def test_normalization(self):
        ...
        for size in sizes:
            window = compute_lanczos_window(size)
            self.assertAlmostEqual(np.max(window), 1.0, 
    ...
    def test_symmetry_odd_size(self):
        ...
        for size in sizes:
            ...
            for i in range(mid_point):
                self.assertAlmostEqual(window[i], window[size-1-i], places=10,
    ...
    def test_specific_values(self):
        ...
        self.assertAlmostEqual(window[0], window[4], places=10,
                              msg="First and last values should be equal")
        ...
        self.assertGreater(window[0], 0, 
                          msg="First value should be positive but small")
        self.assertLess(window[0], 0.3, 
                       msg="First value should be less than 0.3")
