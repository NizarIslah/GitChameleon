...
class TestStackAndSave(unittest.TestCase):
    ...
    def test_safe_path_joining(self):
        ...
        joined_path, _ = stack_and_save([self.float_array], self.base_path, sub_path, 
                                      "safe", np.float32)
