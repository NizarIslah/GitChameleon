import unittest
import numpy as np
from dataset.solutions.sample_131 import apply_percentile_filter
...
class TestPercentileFilter(unittest.TestCase):
    ...
    def test_apply_percentile_filter_different_percentiles(self):
        ...
        np.testing.assert_array_less(min_result, max_result + 1e-10)  # Add small epsilon for floating point comparison
