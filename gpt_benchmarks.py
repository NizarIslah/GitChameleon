...
parser.add_argument('--input_data', type=str, default='/home/mila/d/diganta.misra/projects/CL4Code/final_set.jsonl', help='Path to input data')
parser.add_argument('--output_data', type=str, default='/home/mila/d/diganta.misra/projects/CL4Code/final_gpt/gpt_4o2/t08/', help='Path to output data')
...
parser.add_argument('--azure_endpoint', type=str, default='https://haoc-corruption.openai.azure.com/', help='Azure endpoint')
